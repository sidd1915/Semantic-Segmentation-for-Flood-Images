...
def stream_run():
    ...
    - The images on the right displays the Semantic Segmentation maps generated by architecture trained by our approach. 
    ''')
    ...
    if st.button("Generate"):  
        image_no = random.randint(0, len(os.listdir('Results')))
